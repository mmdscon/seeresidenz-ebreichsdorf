    ...
    <main style={{ background: "#FBFAF7", fontFamily: "var(--font-body), system-ui, sans-serif" }}>
      ...
      <section className="w-full">
        <div className="relative w-full overflow-hidden" style={{ height: "clamp(260px, 38vw, 480px)" }}>
          ...
          <img src="/hero-desktop.jpg" alt="Seeresidenz – Danke" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 40%' }} />
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="mx-auto w-full max-w-6xl px-6 pb-10 md:pb-14">
              <div style={{ opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(18px)", transition: "opacity 0.8s cubic-bezier(0.16,1,0.3,1), transform 0.8s cubic-bezier(0.16,1,0.3,1)" }}>
                <span style={{ display: "inline-flex", alignItems: "center", padding: "4px 14px", background: "rgba(255,255,255,0.16)", border: "1px solid rgba(255,255,255,0.30)", borderRadius: "999px", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.75)", marginBottom: "12px" }}>Anfrage bestätigt</span>
                <h1 style={{ fontSize: "clamp(1.9rem, 4.5vw, 3.2rem)", fontWeight: 300, color: "white", lineHeight: 0.98, margin: 0, fontFamily: "var(--font-heading), system-ui, sans-serif", textTransform: "uppercase", letterSpacing: "-0.02em" }}>
          ...
          <ol className="space-y-7">
            {[
              ...
              <li key={n} style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
                <span style={{ flexShrink: 0, width: "36px", height: "36px", background: "rgba(84,117,135,0.08)", border: "1px solid rgba(84,117,135,0.20)", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: 700, color: "#547587", letterSpacing: "0.04em", marginTop: "1px" }}>{n}</span>
                <div>
